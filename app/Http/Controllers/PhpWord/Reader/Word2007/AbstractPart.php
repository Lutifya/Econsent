...
namespace PhpWord\Reader\Word2007;

use PhpWord\ComplexType\TblWidth as TblWidthComplexType;
use PhpWord\Element\AbstractContainer;
use PhpWord\Element\TextRun;
use PhpWord\Element\TrackChange;
use PhpWord\PhpWord;
use PhpWord\Shared\XMLReader;
...
abstract class AbstractPart
{
     ...
     * Read w:p.
     *
     * @param \PhpWord\Shared\XMLReader $xmlReader
     * @param \DOMElement $domNode
     * @param \PhpWord\Element\AbstractContainer $parent
    ...
    protected function readTable(XMLReader $xmlReader, \DOMElement $domNode, $parent, $docPart = 'document')
    {
        ...
        /** @var \PhpWord\Element\Table $table Type hint */
