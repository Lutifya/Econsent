...
namespace PhpWord\Style;

use PhpWord\Exception\InvalidStyleException;
use PhpWord\Shared\Text;
use PhpWord\SimpleType\Jc;
use PhpWord\SimpleType\TextAlignment;
...
class Paragraph extends Border
{
     ...
     * Indentation
     *
     * @var \PhpWord\Style\Indentation|null
     */
    private $indentation;
     ...
     * Get shading
     *
     * @return \PhpWord\Style\Indentation
     */
     ...
     *
     * @return self
     * @throws \PhpWord\Exception\InvalidStyleException
     */
    public function setLineHeight($lineHeight)
    {
        ...
        $this->setSpacingLineRule(\PhpWord\SimpleType\LineSpacingRule::AUTO);
