...
use PhpWord\Style\AbstractStyle;
use PhpWord\Style\Font;
use PhpWord\Style\Numbering;
use PhpWord\Style\Paragraph;
use PhpWord\Style\Table;
...
class Style
{
     ...
     * @param array|\PhpWord\Style\AbstractStyle $styles
     * @return \PhpWord\Style\Paragraph
     */
     ...
     *
     * @param string $styleName
     * @param array|\PhpWord\Style\AbstractStyle $fontStyle
     * @param array|\PhpWord\Style\AbstractStyle $paragraphStyle
     * @return \PhpWord\Style\Font
     */
     ...
     *
     * @param string $styleName
     * @param array|\PhpWord\Style\AbstractStyle $styleValues
     * @return \PhpWord\Style\Numbering
     * @since 0.10.0
     */
     ...
     *
     * @param array|\PhpWord\Style\AbstractStyle $styles Paragraph style definition
     * @return \PhpWord\Style\Paragraph
     */
     ...
     * Get all styles
     *
     * @return \PhpWord\Style\AbstractStyle[]
     */
     ...
     *
     * @param string $styleName
     * @return \PhpWord\Style\AbstractStyle Paragraph|Font|Table|Numbering
     */
     ...
     *
     * @param string $name
     * @param \PhpWord\Style\AbstractStyle $style
     * @param array|\PhpWord\Style\AbstractStyle $value
     * @return \PhpWord\Style\AbstractStyle
     */
