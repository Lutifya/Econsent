...
class Converter
{
    ...
    {
        switch ($value) {
            case \PhpWord\Style\Font::FGCOLOR_YELLOW:
                return 'FFFF00';
            case \PhpWord\Style\Font::FGCOLOR_LIGHTGREEN:
                return '90EE90';
            case \PhpWord\Style\Font::FGCOLOR_CYAN:
                return '00FFFF';
            case \PhpWord\Style\Font::FGCOLOR_MAGENTA:
                return 'FF00FF';
            case \PhpWord\Style\Font::FGCOLOR_BLUE:
                return '0000FF';
            case \PhpWord\Style\Font::FGCOLOR_RED:
                return 'FF0000';
            case \PhpWord\Style\Font::FGCOLOR_DARKBLUE:
                return '00008B';
            case \PhpWord\Style\Font::FGCOLOR_DARKCYAN:
                return '008B8B';
            case \PhpWord\Style\Font::FGCOLOR_DARKGREEN:
                return '006400';
            case \PhpWord\Style\Font::FGCOLOR_DARKMAGENTA:
                return '8B008B';
            case \PhpWord\Style\Font::FGCOLOR_DARKRED:
                return '8B0000';
            case \PhpWord\Style\Font::FGCOLOR_DARKYELLOW:
                return '8B8B00';
            case \PhpWord\Style\Font::FGCOLOR_DARKGRAY:
                return 'A9A9A9';
            case \PhpWord\Style\Font::FGCOLOR_LIGHTGRAY:
                return 'D3D3D3';
            case \PhpWord\Style\Font::FGCOLOR_BLACK:
                return '000000';
        }
