...
use PhpWord\Reader\ReaderInterface;
use PhpWord\Writer\WriterInterface;
...
abstract class IOFactory
{
     ...
     *
     * @return \PhpWord\Writer\WriterInterface|\PhpWord\Reader\ReaderInterface
     *@throws \PhpWord\Exception\Exception
     *
     */
     ...
     * @return \PhpWord\PhpWord $phpWord
     */
    public static function load($filename, $readerName = 'Word2007')
    {
        /** @var \PhpWord\Reader\ReaderInterface $reader */
