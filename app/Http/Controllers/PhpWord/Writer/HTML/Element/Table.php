...
class Table extends AbstractElement
{
    ...
    {
        if (!$this->element instanceof \PhpWord\Element\Table) {
            return '';
        }
     ...
     *
     * @param string|\PhpWord\Style\Table|null $tableStyle
     * @return string
     */
    private function getTableStyle($tableStyle = null)
    {
        ...
        if (is_string($tableStyle)) {
            ...
            $style = ' style="';
            if ($tableStyle->getLayout() == \PhpWord\Style\Table::LAYOUT_FIXED) {
                $style .= 'table-layout: fixed;';
            } elseif ($tableStyle->getLayout() == \PhpWord\Style\Table::LAYOUT_AUTO) {
