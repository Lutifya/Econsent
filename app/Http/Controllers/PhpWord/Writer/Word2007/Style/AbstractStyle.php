...
namespace PhpWord\Writer\Word2007\Style;
...
abstract class AbstractStyle
{
     ...
     *
     * @var string|\PhpWord\Style\AbstractStyle
     */
    protected $style;
     ...
     * @param string|\PhpWord\Style\AbstractStyle $style
     */
     ...
     * Get XML Writer
     *
     * @return \PhpWord\Shared\XMLWriter
     */
     ...
     * Get Style
     *
     * @return string|\PhpWord\Style\AbstractStyle
     */
    ...
    protected function writeChildStyle(XMLWriter $xmlWriter, $name, $value)
    {
        if ($value !== null) {
            ...
            /** @var \PhpWord\Writer\Word2007\Style\AbstractStyle $writer */
