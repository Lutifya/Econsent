...
use PhpWord\Element\Footnote;
use PhpWord\Shared\XMLWriter;
use PhpWord\Writer\Word2007\Element\Container;
...
class Footnotes extends AbstractPart
{
     ...
     *
     * @var \PhpWord\Collection\Footnotes|\PhpWord\Collection\Endnotes
     */
    protected $elements;
     ...
     * Set element
     *
     * @param \PhpWord\Collection\Footnotes|\PhpWord\Collection\Endnotes $elements
     * @return self
     */
     ...
     * @param \PhpWord\Element\Footnote|\PhpWord\Element\Endnote $element
     */
