...
use PhpWord\Element\Shape as ShapeElement;
use PhpWord\Shared\XMLWriter;
use PhpWord\Style\Shape as ShapeStyle;
use PhpWord\Writer\Word2007\Style\Shape as ShapeStyleWriter;
...
class Shape extends AbstractElement
{
     ...
     * @param \PhpWord\Style\Shape $style
     */
