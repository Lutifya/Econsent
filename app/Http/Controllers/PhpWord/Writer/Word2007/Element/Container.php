...
use PhpWord\Element\AbstractContainer as ContainerElement;
use PhpWord\Element\AbstractElement as Element;
use PhpWord\Element\TextBreak as TextBreakElement;
...
class Container extends AbstractElement
{
    ...
    public function write()
    {
        ...
        if ($writeLastTextBreak) {
            ...
            /** @var \PhpWord\Writer\Word2007\Element\AbstractElement $writer Type hint */
