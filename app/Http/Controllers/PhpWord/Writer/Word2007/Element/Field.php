...
class Field extends Text
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \PhpWord\Element\Field) {
            return;
        }
    ...
    private function writeDefault(\PhpWord\Element\Field $element)
    {
        ...
        if ($element->getText() != null) {
            if ($element->getText() instanceof \PhpWord\Element\TextRun) {
     ...
     */
    protected function writeMacrobutton(\PhpWord\Element\Field $element)
    {
        $xmlWriter = $this->getXmlWriter();
        $this->startElementP();
    ...
    private function buildPropertiesAndOptions(\PhpWord\Element\Field $element)
    {
