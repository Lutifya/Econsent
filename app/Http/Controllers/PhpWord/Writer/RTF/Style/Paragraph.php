...
namespace PhpWord\Writer\RTF\Style;
...
class Paragraph extends AbstractStyle
{
    ...
    {
        $style = $this->getStyle();
        if (!$style instanceof \PhpWord\Style\Paragraph) {
            return '';
        }
     ...
     *
     * @param null|\PhpWord\Style\Indentation $indent
     * @return string
     */
    private function writeIndentation($indent = null)
    {
        if (isset($indent) && $indent instanceof \PhpWord\Style\Indentation) {
