...
namespace PhpWord\Writer\RTF\Element;

use PhpWord\Element\AbstractElement as Element;
use PhpWord\Escaper\Rtf;
use PhpWord\Settings;
use PhpWord\Shared\Text as SharedText;
use PhpWord\Style;
use PhpWord\Style\Font as FontStyle;
use PhpWord\Style\Paragraph as ParagraphStyle;
use PhpWord\Writer\AbstractWriter;
use PhpWord\Writer\HTML\Element\AbstractElement as HTMLAbstractElement;
use PhpWord\Writer\RTF\Style\Font as FontStyleWriter;
use PhpWord\Writer\RTF\Style\Paragraph as ParagraphStyleWriter;
...
abstract class AbstractElement extends HTMLAbstractElement
{
    ...
    {
        /** @var \PhpWord\Writer\RTF $parentWriter Type hint */
        $parentWriter = $this->parentWriter;

        /** @var \PhpWord\Element\Text $element Type hint */
