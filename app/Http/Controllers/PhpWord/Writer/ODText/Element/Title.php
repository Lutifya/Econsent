...
namespace PhpWord\Writer\ODText\Element;
...
class Title extends AbstractElement
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \PhpWord\Element\Title) {
            return;
        }
        ...
        if ($sect instanceof \PhpWord\Element\Section) {
        ...
        if (is_string($text)) {
            $this->writeText($text);
        } elseif ($text instanceof \PhpWord\Element\AbstractContainer) {
     ...
     *
     * @param \PhpWord\Element\AbstractElement $elem
     *
     * @param \PhpWord\Element\AbstractElement[] $elemarray
     *
     * @return bool
     */
