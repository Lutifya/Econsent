...
namespace PhpWord\Writer\ODText\Part;

use PhpWord\Element\AbstractContainer;
use PhpWord\Element\Field;
use PhpWord\Element\Image;
use PhpWord\Element\Table;
use PhpWord\Element\Text;
use PhpWord\Element\TextRun;
use PhpWord\Element\TrackChange;
use PhpWord\PhpWord;
use PhpWord\Shared\XMLWriter;
use PhpWord\Style;
use PhpWord\Style\Font;
use PhpWord\Style\Paragraph;
use PhpWord\Style\Table as TableStyle;
use PhpWord\Writer\ODText\Element\Container;
use PhpWord\Writer\ODText\Style\Paragraph as ParagraphStyleWriter;
...
class Content extends AbstractPart
{
    ...
    private function writeAutoStyles(XMLWriter $xmlWriter)
    {
        ...
        foreach ($this->autoStyles as $element => $styles) {
            ...
            foreach ($styles as $style) {
                /** @var \PhpWord\Writer\ODText\Style\AbstractStyle $styleWriter Type hint */
    ...
    private function writeTextStyles(XMLWriter $xmlWriter)
    {
        ...
        foreach ($this->imageParagraphStyles as $style) {
            $styleWriter = new \PhpWord\Writer\ODText\Style\Paragraph($xmlWriter, $style);
            $styleWriter->write();
        }
    }
     ...
     *
     * @param \PhpWord\Element\AbstractContainer $container
     ...
     *
     * @param \PhpWord\Element\Text $element
     * @param int $paragraphStyleCount
     * @param int $fontStyleCount
     */
     ...
     *
     * @param \PhpWord\Element\Field $element
     * @param int $paragraphStyleCount
     * @param int $fontStyleCount
     */
     ...
     * Get style of individual element
     *
     * @param \PhpWord\Element\TextRun $element
     * @param int $paragraphStyleCount
     */
     ...
     * @param \PhpWord\Element\AbstractElement[] $trackedChanges
     */
