...
use PhpWord\Exception\InvalidImageException;
use PhpWord\Exception\UnsupportedImageTypeException;
use PhpWord\Settings;
use PhpWord\Shared\ZipArchive;
use PhpWord\Style\Image as ImageStyle;
...
class Image extends AbstractElement
{
     ...
     * @param string $name
     *
     * @throws \PhpWord\Exception\InvalidImageException
     * @throws \PhpWord\Exception\UnsupportedImageTypeException
     */
