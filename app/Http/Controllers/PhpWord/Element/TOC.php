...
use PhpWord\Style\TOC as TOCStyle;
...
class TOC extends AbstractElement
{
    ...
    public function getTitles()
    {
        ...
        foreach ($titles as $i => $title) {
            /** @var \PhpWord\Element\Title $title Type hint */
     ...
     * Get Font Style
     *
     * @return \PhpWord\Style\Font|string
     */
