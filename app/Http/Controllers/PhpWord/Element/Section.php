...
use PhpWord\ComplexType\FootnoteProperties;
use PhpWord\Style\Section as SectionStyle;
...
class Section extends AbstractContainer
{
     ...
     * @param null|array|\PhpWord\Style $style
     */
    ...
    private function addHeaderFooter($type = Header::AUTO, $header = true)
    {
        ...
        if (in_array($type, array(Header::AUTO, Header::FIRST, Header::EVEN))) {
            ...
            /** @var \PhpWord\Element\AbstractContainer $container Type hint */
