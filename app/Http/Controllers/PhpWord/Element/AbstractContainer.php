 ...
 *
 * @method \PhpWord\Element\OLEObject addObject(string $source, mixed $style = null) deprecated, use addOLEObject instead
 *
 * @since 0.10.0
 */
abstract class AbstractContainer extends AbstractElement
{
     ...
     * @param mixed $args
     * @return \PhpWord\Element\AbstractElement
     */
    ...
    protected function addElement($elementName)
    {
        ...
        /** @var \PhpWord\Element\AbstractElement $element Type hint */
     ...
     *
     * @param int $index
     * @return \PhpWord\Element\AbstractElement|null
     */
     ...
     *
     * @param int|\PhpWord\Element\AbstractElement $toRemove
     */
    public function removeElement($toRemove)
    {
        ...
        } elseif ($toRemove instanceof \PhpWord\Element\AbstractElement) {
     ...
     * @param mixed $paragraphStyle
     *
     * @return \PhpWord\Element\Footnote
     *
     * @codeCoverageIgnore
     *@deprecated 0.10.0
     *
