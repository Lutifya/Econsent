...
@section('page-style')
{{-- Page css files --}}
<link rel="stylesheet" href="{{ asset(mix('/css/base/pages/ui-colors.css')) }}">
@endsection
        ...
        <div class="card-body">
          <div class="alert alert-primary" role="alert">
            <div class="alert-body">
              ...
              <a
                href="https://pixinvent.com/demo/Econsent-html-bootstrap-admin-template/documentation/documentation-colors.html"
                target="_blank"
                class="alert-link"
                >documentation.</a
              >
          ...
          <div class="d-flex justify-content-start flex-wrap">
            <div
              class="text-center bg-primary bg-lighten-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
              <span>lighten-2</span>
            </div>
            <div
              class="text-center bg-secondary bg-lighten-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
              <span>lighten-2</span>
            </div>
            <div
              class="text-center bg-success bg-lighten-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
              <span>lighten-2</span>
            </div>
            <div
              class="text-center bg-warning bg-lighten-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
              <span>lighten-2</span>
            </div>
            <div
              class="text-center bg-danger bg-lighten-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
              <span>lighten-2</span>
            </div>
            <div
              class="text-center bg-info bg-lighten-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center my-1 ml-50 shadow"
            >
              <span>lighten-2</span>
            </div>
          </div>
          ...
          <div class="d-flex justify-content-start flex-wrap">
            <div
              class="text-center bg-primary bg-darken-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
              <span>darken-2</span>
            </div>
            <div
              class="text-center bg-secondary bg-darken-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
              <span>darken-2</span>
            </div>
            <div
              class="text-center bg-success bg-darken-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
              <span>darken-2</span>
            </div>
            <div
            ...
            <div
              class="text-center bg-danger bg-darken-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
              <span>darken-2</span>
            </div>
            <div
              class="text-center bg-info bg-darken-2 colors-container rounded text-white width-100 height-100 d-flex align-items-center justify-content-center my-1 ml-50 shadow"
            >
              <span>darken-2</span>
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-start flex-wrap">
            ...
            <div
              class="text-center colors-container bg-gradient-secondary rounded text-white width-100 height-100 d-flex align-items-center justify-content-center mr-1 ml-50 my-1 shadow"
            >
